package com.example.imtiazaminsajid.cholo_ridesharingapp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(CustomerLoginActivity.this,
